...
export class EmployeeCreateEditComponent implements OnInit {
  ...
  onOkClick() {
    // GET DATA
    let employeeList = JSON.parse(localStorage.getItem('AppComponent'));
    ...
    if (this.data.origin === 'Add') {
      ...
      this.openSnackBar1('ADD Successful ', '');
    ...
    // SAVE DATA
    localStorage.setItem('AppComponent', JSON.stringify(employeeList));
